...
from brownie import accounts, Rentable, ORentable, YRentable, WRentable, interface, chain
...
def main():
    ...
    for lid in LootsIds:
        ...
        lootContract.transferFrom(effectiveOwner, depositorA, lid, {'from': effectiveOwner})
    ...
    for lid in landIds:
        ...
        landContract.transferFrom(effectiveOwner, depositorB, lid, {'from': effectiveOwner})
    ...
    for d in deposits:
        deposit1tx(n, d['tokenAddress'], d['user'], d['tokenId'], d['maxTimeDuration'], d['pricePerBlock'], d['paymentToken'])
